                    ...
                    <div className="border-t border-gray-100 pt-5">
                      <label className="flex items-start gap-3 cursor-pointer group">
                        ...
                        <span className="text-sm text-gray-600">
                          {t.agreementText} <a href="https://docs.google.com/document/d/1UnzhvBGZDzefqhHtCNKArOByVAHwfHxfYd5_3NEPc0k/preview" target="_blank" rel="noopener noreferrer" className="underline font-medium text-gray-900">{t.menteeAgreement}</a>  <span className="text-red-400">*</span>
                        </span>
                      </label>
                    </div>
